...
@class EditImageAttr, EditImageIntialView, EditVideoAttr, EditVideoLogicItem, MMCircularProgressView, MMLoadingView, MMSightRecordView, NSMutableArray, NSString, ShortVideoToolbarPreviewView, SightCameraTopToolView, UIButton, UIImage, UIImageView, UILabel, UIView;

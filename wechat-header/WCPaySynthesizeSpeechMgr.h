...
@class NSString, WCPaySynthesizeSpeechCgi;

@interface WCPaySynthesizeSpeechMgr : MMService <WCPayLogicMgrExt, WCPaySynthesizeSpeechCgiDelegate, IMsgExt, MMService, VoIPPushKitExt>
{
